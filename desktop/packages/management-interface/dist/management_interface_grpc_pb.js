...
function serialize_mullvad_daemon_management_interface_BridgeSettings(arg) {
  if (!(arg instanceof management_interface_pb.BridgeSettings)) {
    throw new Error('Expected argument of type mullvad_daemon.management_interface.BridgeSettings');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_mullvad_daemon_management_interface_BridgeSettings(buffer_arg) {
  return management_interface_pb.BridgeSettings.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_mullvad_daemon_management_interface_BridgeState(arg) {
  if (!(arg instanceof management_interface_pb.BridgeState)) {
    throw new Error('Expected argument of type mullvad_daemon.management_interface.BridgeState');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_mullvad_daemon_management_interface_BridgeState(buffer_arg) {
  return management_interface_pb.BridgeState.deserializeBinary(new Uint8Array(buffer_arg));
}
...
updateRelayLocations: {
  ...
  setBridgeSettings: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: management_interface_pb.BridgeSettings,
    responseType: google_protobuf_empty_pb.Empty,
    requestSerialize: serialize_mullvad_daemon_management_interface_BridgeSettings,
    requestDeserialize: deserialize_mullvad_daemon_management_interface_BridgeSettings,
    responseSerialize: serialize_google_protobuf_Empty,
    responseDeserialize: deserialize_google_protobuf_Empty,
  },
  setBridgeState: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: management_interface_pb.BridgeState,
    responseType: google_protobuf_empty_pb.Empty,
    requestSerialize: serialize_mullvad_daemon_management_interface_BridgeState,
    requestDeserialize: deserialize_mullvad_daemon_management_interface_BridgeState,
    responseSerialize: serialize_google_protobuf_Empty,
    responseDeserialize: deserialize_google_protobuf_Empty,
  },
